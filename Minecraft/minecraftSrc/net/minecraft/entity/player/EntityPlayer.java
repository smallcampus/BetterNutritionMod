...
public abstract class EntityPlayer extends EntityLivingBase implements ICommandSender
{
    ...
    /**
     * The player's nutrition stats. not implement Food yet
     * @author smallcampus
     */
    protected NutritionStats nutritionStats = new NutritionStats();
    ...
    public void onUpdate()
    {
        ...
        if (!this.worldObj.isRemote)
        {
             ...
             * @author smallcampus
             */
            this.nutritionStats.onUpdate(this);
        }
     ...
     * @author smallcampus
     */
    public NutritionStats getNutritionStats()
    {
